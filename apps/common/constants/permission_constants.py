...
class PermissionConstants(Enum):
    ...
    ORDER_READ = Permission(group=Group.ORDER, operate=Operate.READ, roles=[RoleConstants.ADMIN, RoleConstants.USER])
    ORDER_CREATE = Permission(group=Group.ORDER, operate=Operate.CREATE, roles=[RoleConstants.ADMIN, RoleConstants.USER])
    ORDER_EDIT = Permission(group=Group.ORDER, operate=Operate.EDIT, roles=[RoleConstants.ADMIN, RoleConstants.USER])
    ORDER_DELETE = Permission(group=Group.ORDER, operate=Operate.DELETE, roles=[RoleConstants.ADMIN, RoleConstants.USER])
    ORDER_MANAGE = Permission(group=Group.ORDER, operate=Operate.MANAGE, roles=[RoleConstants.ADMIN])
